...
public class Faculty_of_civil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_of_civil);

        intent = new Intent(Intent.ACTION_DIAL);

        phone1=findViewById(R.id.civil_phone1);
        phone1.setPaintFlags(phone1.getPaintFlags() |   Paint.UNDERLINE_TEXT_FLAG);
        phone1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intent.setData(Uri.parse("tel:+48857469560"));
                startActivity(intent);
            }
        });

        phone2=findViewById(R.id.civil_deans_phone1);
        ...
        email1=findViewById(R.id.civil_email1);
        email1.setPaintFlags(email1.getPaintFlags() |   Paint.UNDERLINE_TEXT_FLAG);
        email1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String to="wbiis@pb.edu.pl";
                Intent intent = new Intent(Intent.ACTION_SEND);
                intent.setData(Uri.parse("mailto:"));
                intent.putExtra(Intent.EXTRA_EMAIL,to);
                intent.putExtra(Intent.EXTRA_SUBJECT, "To Faculty of Civil and Environmental Engineering");
        ...
        email2=findViewById(R.id.civil_dean_email1);
